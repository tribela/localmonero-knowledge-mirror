---
title: "Kako Monero uporablja hard-forke za nadgradnjo omrežja"
...
---
Eden najpogosteje napačno razumljenih delov Monerovega pristopa k izgradnji decentralizirane, varne in varne kriptovalute, ki ohranja zasebnost, je vloga, ki jo imajo hard-forki (ali nadgradnje omrežja).

V tej objavi se bomo sprehodili skozi to, kaj so hard-forki, zakaj so pomembni za Monero in kakšno vlogo lahko igrate pri njih v prihodnosti.
...
Skupnost Monero se je zavezala, da bo sčasoma ponovila in izboljšala projekt, in zdi se, da se ta zaveza zmanjša na dva ključna vidika etosa skupnosti: 
  ...
  2. Projekt Monero je orodje za zasebnost, boj za zasebnost pa je nenehno napredujoča oboroževalna tekma. Ljudje in skupine, ki bi radi nič drugega kot osvobodili svet zasebnosti (tako finančne kot osebne), se nenehno izboljšujejo, razvijajo in izumljajo nove načine za napad na sodobne pristope k ohranjanju zasebnosti, kot so tisti, ki jih uporablja Monero. Ker sovražniki zasebnosti najdejo te nove pristope, mora biti omrežje Monero sposobno prilagoditi in izboljšati, da se upre in brani našo pravico do finančne zasebnosti.

Projekt Monero je v končni fazi programska oprema – koda – ki so jo napisali ljudje. To lahko povzroči potrebo po odpravljanju napak, dodajanju izboljšav, ki so odkrite ali izumljene sčasoma, izvajanju posodobitev protokola ali preprosto vzdrževanju projekta. To je v mnogih pogledih podobno drugim delom programske opreme, ki jo uporabljate (na primer brskalniku, v katerem to berete!), ki se mora nenehno posodabljati, da lahko doda nove funkcije in odpravi napake.

Projekt Monero je orodje za zasebnost, boj za zasebnost pa je nenehno napredujoča oboroževalna tekma. Ljudje in skupine, ki bi radi nič drugega kot osvobodili svet zasebnosti (tako finančne kot osebne), se nenehno izboljšujejo, razvijajo in izumljajo nove načine za napad na sodobne pristope k ohranjanju zasebnosti, kot so tisti, ki jih uporablja Monero. Ker sovražniki zasebnosti najdejo te nove pristope, mora biti omrežje Monero sposobno prilagoditi in izboljšati, da se upre in brani našo pravico do finančne zasebnosti.
...
Ker ni osrednjega organa, izvršnega direktorja ali predsednika Monera, je delo pri odločanju, kdaj nadgraditi omrežje, kaj vključiti in kako se tega lotiti, v rokah _nas_ , tistih ljudi v skupnosti Monero, ki se odloči za sodelovanje in interakcijo! To je izjemno pomemben del decentraliziranega projekta, saj sta načrtovanje in odločanje za projekt na koncu decentralizirana in množično izvira iz skupnosti.

Načrtovanje časa in funkcij, vključenih v vsako nadgradnjo omrežja v Monero, poteka na dveh glavnih mestih: 

  1. Na IRC in Matrix, najpogosteje uporabljenih platformah za klepet v skupnosti Monero (ki sta povezani skupaj). Te platforme omogočajo velike skupinske klepete in na njih potekajo vsi načrtovani sestanki skupnosti Monero, sestanki razvijalcev in sestanki raziskovalnih laboratorijev. Ti sestanki so najboljši način, da prisluhnete (ali prispevate!) k načrtovanju in razpravi o nadgradnjah omrežja v Monero.

  2. Na Githubu, glavni komunikacijski platformi za dolgotrajne razprave, načrtovanje in organizacijo Monero. Skupnost Monero uporablja Github za organizacijo srečanj, razpravo o novih funkcijah in idejah ter usklajevanje načrtovanja nadgradenj omrežja poleg shranjevanja kode za projekt Monero.

Na IRC in Matrix, najpogosteje uporabljenih platformah za klepet v skupnosti Monero (ki sta povezani skupaj). Te platforme omogočajo velike skupinske klepete in na njih potekajo vsi načrtovani sestanki skupnosti Monero, sestanki razvijalcev in sestanki raziskovalnih laboratorijev. Ti sestanki so najboljši način, da prisluhnete (ali prispevate!) k načrtovanju in razpravi o nadgradnjah omrežja v Monero.

Na Githubu, glavni komunikacijski platformi za dolgotrajne razprave, načrtovanje in organizacijo Monero. Skupnost Monero uporablja Github za organizacijo srečanj, razpravo o novih funkcijah in idejah ter usklajevanje načrtovanja nadgradenj omrežja poleg shranjevanja kode za projekt Monero.

Če imate pomembno idejo za nadgradnjo omrežja, vam ni všeč izbrani pristop ali vas skrbi čas nadgradnje, je pomembno, da spregovorite in jasno predstavite svoj primer skupnosti! 
...
Tukaj je nekaj preprostih načinov, s katerimi lahko pomagate zgladiti stvari pri nadgradnji omrežja: 
  ...
  1. Pridružite se načrtovalnim sestankom [, objavljenim na Githubu ](https://github.com/monero-project/meta/issues), prisluhnite in prispevajte, če želite izpostaviti kaj pomembnega.
...
Čeprav datum še ni določen, bo kmalu prišlo do nadgradnje omrežja za izvajanje nekaj ključnih nadgradenj in funkcij pri Monero: 

  1. Povečanje velikosti obroča z 11 na 16, s čimer se poveča osnovni nabor anonimnosti (beri: verjetno zanikanje ali osnovna zasebnost) vsake transakcije v omrežju 
  2. [Ogled oznak, odličen način za skrajšanje časa sinhronizacije denarnice za 30–40 %](https://localmonero.co/knowledge/view-tags-reduce-monero-sync-time)
  3. Spremembe provizij, izboljšanje varnosti in odpornosti omrežja na hitre spremembe na trgu provizij ali napade zlonamernih subjektov
  4. [Bulletproofs+, nadaljnje izboljšanje učinkovitosti transakcij Monero](https://www.getmonero.org/2020/12/24/Bulletproofs+-in-Monero.html)

Te spremembe bodo močno pripomogle k povečanju zasebnosti, učinkovitosti in varnosti omrežja, hkrati pa bodo tlakovale pot za [Seraphis](https://localmonero.co/knowledge/seraphis-for-monero), transakcijski protokol naslednje generacije za Monero.
