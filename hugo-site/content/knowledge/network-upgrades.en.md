...
While there is not a date set in stone yet, there will be a network upgrade soon to implement a few key upgrades and features in Monero:
  ...
  2. [View tags, a brilliant way to reduce wallet sync times by 30-40%](/knowledge/view-tags-reduce-monero-sync-time/)
...
These changes will go a long way to increasing the privacy, efficiency, and security of the network, all while paving the way for [Seraphis](/knowledge/seraphis-for-monero/), the next-generation transaction protocol for Monero.
