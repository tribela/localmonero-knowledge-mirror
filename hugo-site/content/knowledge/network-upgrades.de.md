...
Obwohl es noch kein in Stein gemeißeltes Datum gibt, wird es bald ein Netzwerk-Upgrade geben, um einige wichtige Upgrades und Funktionen in Monero zu implementieren:
  ...
  2. [Tags anzeigen, eine hervorragende Möglichkeit, die Synchronisierungszeiten der Wallet um 30–40% zu reduzieren](https://localmonero.co/knowledge/view-tags-reduce-monero-sync-time)
...
Diese Änderungen werden einen großen Beitrag zur Erhöhung der Privatsphäre, Effizienz und Sicherheit des Netzwerks leisten und gleichzeitig den Weg für [Seraphis](https://localmonero.co/knowledge/seraphis-for-monero) ebnen, das Transaktionsprotokoll der nächsten Generation für Monero.
