---
title: "„Monero“ geriausia praktika pradedantiesiems"
...
---
Daugelis vartotojų gali būti šokiruoti sužinoję, kad ekspertai mano, kad kriptovaliutą galima naudoti neteisingai. Priklausomai nuo to, nuo ko ginasi vartotojas, yra tam tikrų veiksmų ir atsargumo priemonių, kurių reikia imtis siekiant išsaugoti privatumą, išvengti sukčiavimo ir užtikrinti tinkamą bei savalaikį operacijų pristatymą. Laimei, Monero kūrėjai padarė viską, ką galėjo, kad nustatytų protingus numatytuosius nustatymus šiose srityse, todėl vartotojai, kurie naudoja piniginės programinę įrangą tokią, kokia yra, didžiąją laiko dalį bus saugūs. Nepaisant to, norėtume skirti šiek tiek laiko ir panagrinėti kelis atvejus, kai gali būti naudinga šiek tiek labiau apgalvoti savo išlaidas.
...
Kai kurios aferos naudoja jūsų kompiuteryje esančią kenkėjišką programą, kuri pakeičia kopijavimo / įklijavimo funkciją, kad vietoje numatyto gavėjo būtų nurodytas kenkėjiškų programų kūrėjo adresas. Kadangi Monero adresai yra ilgi ir nepatogūs, gali kilti pagunda tiesiog patikrinti keletą pirmųjų skaičių ir raidžių ir vadinti juos gerais, o gal net nekartoti adreso. Nors tikriausiai nebūtina tikrinti viso adreso, daugeliu atvejų užteks patikrinti pirmąją ir paskutinę tuziną adreso simbolių. Adresams, kuriais dažnai siunčiate, daugelyje piniginių yra adresų knygos funkcija, kuri automatiškai įves pasirinktą išsaugotą adresą. Vis dėlto geriausia atlikti greitą patikrinimą.
...
Privatumo srityje dažnai per lengva netyčia nutekėti arba atskleisti duomenis apie save, kurie gali būti naudojami jūsų tapatybei nustatyti. Senas pavyzdys, kuris nebegalioja Monero, yra pasirinktiniai žiedų dydžiai. Jei numatytoji vertė yra 11, o visi naudoja 11, bet jūs nuolat naudojate 54, taip, skaičius yra didesnis, todėl jūsų anonimiškumas yra didesnis, bet dabar jūs išsiskiriate iš minios ir jūsų operacijas lengviau atpažinti. Nuo to laiko Monero atnaujino, kad žiedo dydis būtų 11, todėl dabar visi atrodo vienodai.
