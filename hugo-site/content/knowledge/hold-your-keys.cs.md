---
title: "Proč (a jak!) byste měli držet své vlastní klíče"
slug: "hold-your-keys"
date: "2022-03-11"
...
---
Slyšeli jste už frázi „ne Vaše klíče, ne Vaše mince“? To se stalo v kryptoměnové komunitě všudypřítomnou frází, ale přestože to většina lidí slyšela, drtivá většina kryptoměn uživatelé nedrží své vlastní klíče.

Výhody kryptoměny, které ji skutečně odlišují od tradiční finanční systém se realizuje pouze tehdy, když máte kompletní úschovu Vašich finančních prostředků – držíte soukromé klíče k Vašim coinům.

V tomto krátkém příspěvku se ponoříme do toho, proč byste měli držet své vlastní klíče a poskytněte několik jednoduchých způsobů, jak spravovat své Monero _ještě dnes_.
...
Jedním ze základních aspektů Monero je umožnění transakcí odolných vůči cenzuře - umožňuje vám provádět transakce, které mohou, ale nemusí být schváleny "jimi", bez ohledu na to, co se vám snaží zabránit. Ačkoli potřeba odolnosti vůči cenzuře může být pro ty z nás, kteří žijí ve "svobodných" zemích, poněkud ztracená, rychlý posun směrem k autoritářství a politickému úpadku v mnoha částech světa způsobuje, že je den ode dne zřejmější, že potřebujeme způsob, jak provádět transakce s nebo bez vládního souhlasu.

Pokud však nemáte vlastní klíče, může vláda nebo regulační orgán snadno donutit burzu nebo správce, aby vaše prostředky zařadil na černou listinu, zabavil je a vydal rozhodnutí o jejich zabavení. nebo cenzurovat transakce na konkrétní adresy. To je již dnes v důsledku sankcí na úrovni států v širokém měřítku děje a bude to stále častějším tématem, protože vlády a regulační orgány si uvědomují, že burzy a správci jsou nejsnazší cestou ke kontrole nad používáním měny Monero.

Může také nastat den, kdy vláda zakáže vlastní úschovu měny Monero, a pokud jste si ještě nevybrali svou měnu Monero z burzy nebo od správce, možná už to nikdy nebudete moci udělat.

Hypotetickým, ale možným scénářem by mohl být nejhorší případ pro ty, kteří se rozhodnou nemít své vlastní klíče - jejich Monero ukradne hacker nebo je zabaví vláda příkazem podobným [příkazu 6102](https://en.wikipedia.org/wiki/Executive_Order_6102).

[Téměř 500 milionů $](https://blog.chainalysis.com/reports/2022-crypto-crime-report-introduction/) v kryptoměnách a celkem 3,2 miliardy dolarů bylo odcizeno v roce 2021 bylo z centralizovaných burz uživatelům, kteří se z toho či onoho důvodu vzdali úschovy prostředků. Jedná se o jedno z největších rizik pro uživatele kryptoměn a s rostoucí popularitou kryptoměn nadále roste jak počet případů, tak jejich objem. Pokud má burza klíče k vašim finančním prostředkům, mohou být tyto prostředky odcizeny hackerem (nebo samotnou burzou!) kdykoli.

Pokud máte své vlastní klíče, jediným skutečným rizikem krádeže nebo zabavení jsou podvody a fyzické útoky, což je mnohem méně pravděpodobné a obvykle se to stává pouze vysoce postaveným osobám nebo těm, kteří byli poškozeni krádeží nebo ztrátou údajů know-your-customer (KYC) z centralizovaných burz, které spojují jejich ID a adresu s vlastnictvím kryptoměn.

Další důležitý aspekt držení vlastních klíčů je méně osobní a více společný. Když drtivá většina uživatelů Monera drží své vlastní klíče, burzy mají menší možnost lhát o množství Monera, které uchovávají, a obchodovat s "papírovým Monerem", protože uživatelé nedrží své Monero na burzách.
...
Když začnete mít v ruce vlastní klíče, nejdůležitější je pamatovat si, že _je třeba uložit a uchovávat svou seed frázi v bezpečí_! Jedná se o sadu 14 nebo 25 náhodných slov, kterou vám při vytvoření peněženky poskytne každá peněženka Monero, a je to vše, co budete potřebovat k získání svých prostředků zpět, pokud ztratíte telefon, stolní počítač, notebook nebo zapomenete heslo.

S touto seed frází zacházejte, jako by měla hodnotu všech peněz Monero ve vaší peněžence, protože každý, kdo ji získá, bude mít úplný přístup k prostředkům ve vaší peněžence. Ideální je uchovávat ji v trezoru nebo na tajném místě, uchovat si více kopií pro případ požáru nebo přírodní katastrofy a nikdy ji nikomu neukázat.

Další informace o seed frázích naleznete v části [Mnemonic Seed | Moneropedia](https://web.getmonero.org/resources/moneropedia/mnemonicseed.html).

Pokud jste hlavně uživatelé stolních počítačů a neutrácíte/přijímáte Monero na cestách příliš často, existuje několik solidních možností, jak si držet vlastní klíče, aniž byste se museli spoléhat na třetí strany.

  * [Oficiální Monero peněženka](https://getmonero.org/downloads)
    * Jedná se o oficiální software peněženky Monero, který je neustále vylepšován a doplňován. Obsahuje integrovaného démona Monero (pokud chcete), je uživatelsky velmi přívětivý a brzy bude podporovat [těžbu přes p2pool přímo z vaší peněženky](https://localmonero.co/knowledge/p2pool-decentralizing-monero-mining).
  * [Peněženka Feather](https://featherwallet.org/)
    * Jedná se o vynikající peněženku v duchu [Electrum pro Bitcoin,](https://electrum.org/) a poskytuje jak jednoduchou použitelnost, tak extrémně výkonné funkce v jediné peněžence.

  * Jedná se o oficiální software peněženky Monero, který je neustále vylepšován a doplňován. Obsahuje integrovaného démona Monero (pokud chcete), je uživatelsky velmi přívětivý a brzy bude podporovat [těžbu přes p2pool přímo z vaší peněženky](https://localmonero.co/knowledge/p2pool-decentralizing-monero-mining).

  * Jedná se o vynikající peněženku v duchu [Electrum pro Bitcoin,](https://electrum.org/) a poskytuje jak jednoduchou použitelnost, tak extrémně výkonné funkce v jediné peněžence.

Pro ty z nás, kteří chtějí mít možnost používat své Monero na cestách nebo často utrácet, je nesmírně důležité mít solidní mobilní peněženku Monero, která stále drží naše klíče v našich rukou.

  * [Peněženka Cake](https://cakewallet.com/)
    * Cake Wallet je bezplatná peněženka s otevřeným zdrojovým kódem (FOSS) pro Android a iOS, která nativně podporuje Monero, Bitcoin a Litecoin.
  * [Monerujo](https://www.monerujo.io/)
    * Monerujo je peněženka FOSS pro Android, která má některé úžasné přidané funkce a grafiku, nativní podporu uzlů Tor a mnoho dalšího.
