...
Chociaż nie ma jeszcze ustalonej daty, wkrótce nastąpi aktualizacja sieci mająca na celu zaimplementowanie kilku kluczowych aktualizacji i funkcji w Monero: 
  ...
  2. [View tagi, genialny sposób na redukcję czasu synchronizacji portfela o 30-40%](/knowledge/view-tags-reduce-monero-sync-time/)
...
Te zmiany przyniosą daleko idące usprawnienia prywatności, wydajności i bezpieczeństwa sieci, jednocześnie torując drogę dla [Seraphisa](/knowledge/seraphis-for-monero/) \- protokołu transakcji nowej generacji dla Monero.
