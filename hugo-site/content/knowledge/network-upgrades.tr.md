...
Henüz kesin bir tarih belirlenmemiş olsa da, Monero'da birkaç önemli yükseltmeyi ve özelliği uygulamak için yakında bir ağ yükseltmesi yapılacak:
  ...
  2. [Cüzdan senkronizasyon sürelerini %30-40 oranında azaltmanın harika bir yolu olan etiketleri görüntüleyin](/knowledge/view-tags-reduce-monero-sync-time/)
...
Bu değişiklikler ağın gizliliğini, verimliliğini ve güvenliğini artırmada uzun bir yol kat edecek ve aynı zamanda Monero için yeni nesil işlem protokolü olan [Seraphis](/knowledge/seraphis-for-monero/)'in önünü açacak.
