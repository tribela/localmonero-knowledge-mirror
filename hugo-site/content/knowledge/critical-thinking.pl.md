---
title: "Dlaczego Monero ma najbardziej krytycznie myślącą społeczność"
...
Jako użytkownik kryptowalut, chętny do wspierania dobrych projektów i [niestracenia wszystkich swoich pieniędzy](/knowledge/monero-scams), zachęcam do myślenia krytycznego i ewaluacji rzeczywistej wartości projektów. Ale czy społeczność danego projektu sama musi przejawiać samokrytykę i być świadoma wad?
...
Można to łatwo zauważyć w dodaniu [RingCT](/knowledge/monero-ringct). Wcześniej Monero zawierało tylko [stealth addresses](/knowledge/monero-stealth-addresses) i [ring signatures](/knowledge/ring-signatures), więc kwoty były widoczne. Shen Noether, badacz MRL, zmodyfikował protokół do tego stopnia, że kwoty są schowane w Monero ale uwzględnienie tej zmiany sprawiło, że transakcje starego typu nie są już dozwolone.
