...
Bár még nincs kőbe vésett dátum, hamarosan hálózatfrissítésre kerül sor, amely néhány kulcsfontosságú újítást és funkciót valósít majd meg a Moneroban:
  ...
  2. [Nézetcímkék: zseniális módja annak, hogy 30-40%-kal csökkenjen a pénztárcák szinkronizálási ideje](/knowledge/view-tags-reduce-monero-sync-time/)
...
Ezek a változtatások nagyban hozzájárulnak a hálózat adatvédelmének, hatékonyságának és biztonságának növeléséhez, miközben megnyitják az utat a [Seraphis](/knowledge/seraphis-for-monero/), a Monero következő generációs tranzakciós protokollja előtt.
