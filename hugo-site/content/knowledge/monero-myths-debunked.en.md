---
title: "Top 15 Monero Myths and Concerns Debunked"
...
---
No cryptocurrency is without its shortcomings, and Monero is no exception. In fact, the community has [made a YouTube series](https://www.youtube.com/playlist?list=PLsSYUeVwrHBnAUre2G_LYDsdo-tD0ov-y) covering the privacy weaknesses of Monero from a technological standpoint.
...
That said, there are some common criticisms levied toward Monero that are either outdated, or incorrect, while others are presenting a very narrow view of the problem in question. In this article we hope to set the record straight on these criticisms.
  ...
  1. [Monero will face regulatory scrutiny far beyond other cryptocurrencies because of its commitment to privacy and anonymity in its transactions.](/knowledge/monero-myths-debunked#1)/
  2. [Monero has fewer wallet options.](/knowledge/monero-myths-debunked#2)/
  3. [Monero has a poor user experience.](/knowledge/monero-myths-debunked#3)/
  4. [Monero will become obsolete if a more popular blockchain adopts strong privacy technology.](/knowledge/monero-myths-debunked#4)/
  5. [Doesn’t Monero have very high transaction fees?](/knowledge/monero-myths-debunked#5)/
  6. [A Monero transaction is many times bigger than a Bitcoin transaction.](/knowledge/monero-myths-debunked#6)/
  7. [Monero has hard forks quite often. Doesn’t this mean it’s centralized?](/knowledge/monero-myths-debunked#7)/
  8. [This is fluffypony’s personal coin!](/knowledge/monero-myths-debunked#8)/
  9. [The majority of commits since 2017 have come from an individual known as moneromooo-monero](/knowledge/monero-myths-debunked#9)/
  10. [Isn’t Monero easily 51% attacked?](/knowledge/monero-myths-debunked#10)/
  11. [CPU-friendly algorithm? Won’t Monero mining just get taken over by botnets?](/knowledge/monero-myths-debunked#11)/
  12. [Monero forks don’t just hurt Monero’s economic viability, but its privacy!](/knowledge/monero-myths-debunked#12)/
  13. [Didn’t Monero have a crippled miner in the early days that was used to enrich the founders?](/knowledge/monero-myths-debunked#13)/
  14. [If Monero is so private, how can we audit the supply to ensure nobody is printing free Monero under our noses?](/knowledge/monero-myths-debunked#14)/
  15. [Most of Monero’s current hashrate comes from just two pools.](/knowledge/monero-myths-debunked#15)/
...
## 1\. Monero will face regulatory scrutiny far beyond other cryptocurrencies because of its commitment to privacy and anonymity in its transactions.
...
## 2\. Monero has fewer wallet options.
...
## 3\. Monero has a poor user experience.
...
## 4\. Monero will become obsolete if a more popular blockchain adopts strong privacy technology.
...
Switching gears one last time for this question, less often this argument applies to technology like an ethereum smart contract using zk-SNARKS, which, once again, does not have mandatory privacy on the base layer of the main chain, so the anonymity sets will be quite small and of dubious ability to adequately protect privacy. For other comparisons, please see our [article comparing Monero to the other major privacy coins](/knowledge/why-monero-is-better).

## 5\. Doesn’t Monero have very high transaction fees?
...
## 6\. A Monero transaction is many times bigger than a Bitcoin transaction.

## 6\. A Monero transaction is many times bigger than a Bitcoin transaction.

## 7\. Monero has hard forks quite often. Doesn’t this mean it’s centralized?

## 7\. Monero has hard forks quite often. Doesn’t this mean it’s centralized?

In the 2017-2018 era, the Monero community made a commitment to keep ASICs off of the network. This was done by continuously hard forking every six months to a new proof-of-work algorithm, which would stop ASICs from taking over the network. The printer analogy in our [article on mining in Monero](/knowledge/monero-mining-randomx) explains how this works.
...
## 8\. This is fluffypony’s personal coin!
...
## 9\. The majority of commits since 2017 have come from an individual known as moneromooo-monero
...
## 10\. Isn’t Monero easily 51% attacked?
...
This, thankfully, is no longer the case. A keen eyed reader will see that the website has actually taken Monero off of their application, due to the inclusion of RandomX. Once again, the reader is encouraged to read [our article on RandomX for details](/knowledge/monero-mining-randomx), but due to the CPU-friendly nature of the algorithm, no longer can businesses like NiceHash just purchase ASICs for Monero to rent out to whoever is willing to rent them. Now, they have to compete with CPUs, which are much more prevalent and easier to obtain.
...
## 11\. CPU-friendly algorithm? Won’t Monero mining just get taken over by botnets?
...
## 12\. Monero forks don’t just hurt Monero’s economic viability, but its privacy!
...
## 13\. Didn’t Monero have a crippled miner in the early days that was used to enrich the founders?
...
## 14\. If Monero is so private, how can we audit the supply to ensure nobody is printing free Monero under our noses?
...
## 15\. Most of Monero’s current hashrate comes from just two pools.
